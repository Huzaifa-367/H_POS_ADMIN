...
import 'package:pos_admin/Provider/subacription_plan_provider.dart';
import 'package:pos_admin/model/subscription_plan_model.dart';
                        ...
                        GestureDetector(
                          ...
                          onTap: () async {
                            ...
                            DatabaseReference ref = FirebaseDatabase.instance
                                .ref("Admin Panel/Subscription Plan/$imageKey");
                            await ref.remove();
                              ...
                              onTap: () async {
                                if (validateAndSave()) {
                                  ...
                                  await ref.update({
                                    'subscriptionName':
                                        subscriptionPlansModel.subscriptionName,
                                    'subscriptionPrice': subscriptionPlansModel
                                        .subscriptionPrice,
                                    'saleNumber':
                                        subscriptionPlansModel.saleNumber,
                                    'purchaseNumber':
